...
//#define RELAY PBout(2)   	//LED3 
#define BEEP PAout(15)   	//LED4 
#define key1 PCin(4)
//#define RUNLED PCout(12)
#define DE485 PBout(9) 
#define EN_BAT PBout(8)
#define EN_LCD PBout(13)

#define RELAY3 PDout(6)
#define RELAY2 PDout(5)
#define RELAY1 PDout(4)
#define RUNLED2 PCout(13)
#define RUNLED1 PCout(12)
